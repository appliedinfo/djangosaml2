...
class LoginView(SPConfigMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        #if self.should_prevent_auth(request) and not mfa_account:
...
class AssertionConsumerServiceView(SPConfigMixin, View):
    ...
    def post(self, request, attribute_mapping=None, create_unknown_user=None):
        ...
        relay_state = self.build_relay_state(session_id=session_id)
    ...
    def authenticate_user(
        ...
        #this we have to check , when we test the sso on server, we can remove this
        #if not needed
    ...
    def build_relay_state(self, session_id=None) -> str:
